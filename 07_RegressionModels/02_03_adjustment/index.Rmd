...
```
horizontal lines from the above show marginal effect of treatment vs control without considering X, the confounder
...
points(x[(n/2 + 1) : n], y[(n/2 + 1) : n], pch = 21, col = "black", bg = "salmon", cex = 2)
```
this figure shows Simpson's paradox - effect reverses itself with the inclusion of another variable
